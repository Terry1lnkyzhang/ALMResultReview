...
7. `required` means Description or Expected requires the controlled-equipment identity to be recorded.
...
9. An explicit operation on the same device in Description or Expected establishes continuity even
   ...
   controlled equipment. Do not classify it as `dut_or_other` merely because Actual does not repeat
